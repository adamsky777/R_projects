...
View(brain_data)
 ...
 "since we omitted records we need to assign new row names to the record by using this command:
 by default if we omit rows in R rows numbers (rownames) will be the follwong 1,2,4,5 (since we omitted row 3rd)
